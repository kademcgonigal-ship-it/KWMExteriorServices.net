...
KWM Exterior Services is a single-page marketing website for an exterior services business (lawn care, landscaping, haul-off, pressure washing, etc.). Built with TanStack Start and deployed on Netlify. The site is intentionally minimal — one public route, no authentication, no database, and no AI assistant.
